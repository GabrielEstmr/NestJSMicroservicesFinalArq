...
export class CategoriasService {
    ...
    async consultarCategoriasPeloId(categoria: string): Promise<Categoria> {
        ...
        //populate('jogadores') => popula o retorno com a relação entre cat e jog (não só com id mas tbm dados dos jogs)
        return await this.categoriaModel.findOne({ categoria }).populate('jogadores').exec();
    }
    ...
    async atribuirCategoriaJogador(params: string[]): Promise<void> {
        ...
        //Vendo que há o jogador => chamando metodo do service de jogadores via injeção dependencia
        //se nao há da erro e já para a aplicação
        await this.jogadoresService.consultarJogadorPeloId(idJogador)



        //como é array pode utilizar push
        categoriaEncontrada.jogadores.push(idJogador);
        //Atualizando com a propria categoriaEncontrada com o jogador incluido
